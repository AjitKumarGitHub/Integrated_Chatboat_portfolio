  ...
  return (
    <div id="Experience" className="p-10 md:p-24">
      ...
      <div className="flex flex-wrap w-full  " >
        <div className="flex flex-row  flex-wrap md:w-full gap-8 md:p-12 py-10 w-full">
          ...
          <div className="p-3 bg-zinc-950 flex items-center rounded-2xl ">
            <FontAwesomeIcon icon={faPython} color="#306998" size="8x" />
        </div>
        <div className="p-3 bg-zinc-950 flex items-center rounded-2xl">
            <FontAwesomeIcon icon={faNodeJs} color="#306998" size="8x" />
        </div>
        </div>
        {/* <div>
